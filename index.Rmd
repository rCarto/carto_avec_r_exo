...
knitr::opts_chunk$set(echo = FALSE, eval = FALSE, cache = TRUE, nm=TRUE)
```
...
* Téléchargez les données :  
    ...
    **gpkg** est disponible ici : **Occitanie.gpkg - insert link**. Il faut télécharger le 
    ...
    * Un fichier contenant des données socio-démographiques sur les communes de
    France est disponible ici : **base_cc_comparateur.xls - insert link**. Il faut le télécharger et le mettre également dans le même dossier **data**.  
