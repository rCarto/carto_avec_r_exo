...
layoutLayer(title = "Echelle : Region - Maillage : Communes", scale = FALSE)

plot(st_geometry(dep76), col = "lightblue", border = "lightblue4")
layoutLayer(title = "Echelle : Région - Maillage : Département", scale = FALSE)

plot(st_geometry(com31), col = "lightblue", border = "lightblue4")
layoutLayer(title = "Echelle : Département - Maillage : Communes", scale = FALSE)
