...
Un fichier contenant les polygones des communes d'Occitanie au format **gpkg** 
est disponible ici : **insert link**. Il faut télécharger le fichier puis le 
placer dans le dossier **data** que vous venez de créer. 
